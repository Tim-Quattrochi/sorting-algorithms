...
def test_selection_sort(test_arr, sorted_arr):
    returned_arr, comparisons, swaps = selection_sort(test_arr)
    assert returned_arr == sorted_arr
    assert comparisons >= swaps, "expected comparisons to be greater than swaps"
...
def test_insertion_sort(test_arr, sorted_arr):
    returned_arr, comparisons, swaps = insertion_sort(test_arr)
    assert returned_arr == sorted_arr
    assert comparisons >= swaps, "expected comparisons to be greater than swaps"
